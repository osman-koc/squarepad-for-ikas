      ...
      <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            ...
            <h1 className="text-2xl font-semibold text-foreground">Ürün görsellerinizi kare formata taşıyın</h1>
          </div>
        </div>
        <div className="space-y-3 md:max-w-sm md:text-right">
          <p className="text-sm text-muted-foreground">Katalogdan, URL’den veya XML feed’inden kare görseller üretip ekibinizle saniyeler içinde paylaşın.</p>
